...
const createOrder = (req, res) => {
  Booking.create(
    {
      from: req.body?.details.from,
      to: req.body?.details.to,
      parcelType: req.body?.details.parcelType,
      parcelWeight: req.body?.details.parcelWeight,
      parcelWidth: req.body?.details.parcelWeight,
      parcelHeight: req.body?.details.parcelHeight,
      parcelLength: req.body?.details.parcelLength,
      parcelDescription: req.body?.details.parcelDescription,
      paymentMode: req.body?.details.paymentMode,
      parcelPaymentCollection: req.body?.details.parcelPaymentCollection,
      parcelImages: req.body?.details.parcelImages,
      billImages: req.body?.billImages,
      createdBy: req.body?.details.createdBy,
